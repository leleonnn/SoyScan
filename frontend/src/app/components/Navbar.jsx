                ...
                <div className="flex flex-rows h-full content-center  md:show">
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute z-10 hidden bg-green-3 group-hover:block w-60  shadow-lg">
                            <Link href="/Upload" className={`block px-4 py-2 mx-1 my-2 rounded-md hover:bg-green-4 ${
                                upload? "bg-green-4 text-green-1 font-bold" : "bg-green-3 text-white font-semibold"
                            }`}>Upload Image</Link>
                            <Link href="/Camera" className={`block px-4 py-2 mx-1 my-2 rounded-md hover:bg-green-4 ${
